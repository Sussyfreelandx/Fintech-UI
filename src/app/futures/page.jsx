...
export default function FuturesPage() {
    return (<>
      <div className="relative min-h-screen bg-gradient-to-br from-teal-950/30 via-slate-950/60 to-zinc-950/60">
      <Navbar />
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-display">
            <span className="text-gradient-primary">Futures Trading</span> on Oakmont Digital Markets Group
          </h1>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <div className="glass p-6 rounded-xl">
              <Percent className="h-8 w-8 text-blue-400 mb-3"/>
            ...
            <div className="glass p-6 rounded-xl">
              <Gauge className="h-8 w-8 text-blue-400 mb-3"/>
