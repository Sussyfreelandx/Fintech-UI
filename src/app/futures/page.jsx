...
export const metadata = {
    title: 'Futures Trading - Oakmont Digital Markets Groups',
    description: 'Explore live futures markets through the Oakmont Digital Markets Groups multi-asset brokerage hub.',
};
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-display">
            <span className="text-gradient-primary">Futures Trading</span> on Oakmont Digital Markets Groups
          </h1>
          <p className="mt-4 text-lg text-white/70">
            Professional derivatives access for clients who understand risk, margin, and liquidation mechanics. Oakmont Digital Markets Groups presents futures as a controlled fintech workflow with clear margin visibility, risk alerts, and account-level governance.
          </p>
