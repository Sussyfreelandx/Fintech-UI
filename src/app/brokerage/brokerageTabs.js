export const BROKERAGE_TABS = [
  ...
  { id: 'commodities', label: 'Commodities',  blurb: 'Energy, industrial metals and agricultural contracts: oil, gas, copper, wheat, coffee and more.' },
