        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 space-y-6 text-white/70">
            ...
            <section>
              ...
              <p className="mt-2">
                AurumX does not provide investment advice. All information on the platform is for informational purposes only. Consult a qualified financial adviser before making investment decisions.
              </p>
            </section>
            ...
            <section>
              <p className="mt-4 text-sm text-white/50 italic">
                By using AurumX, you acknowledge that you have read and understood these risks. You accept full responsibility for your trading decisions and any resulting losses.
              </p>
            </section>
          </div>
        </div>
