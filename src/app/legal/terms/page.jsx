...
export const metadata = {
    title: 'Terms of Service - Oakmont Digital Markets Groups',
    description: 'Oakmont Digital Markets Groups Terms of Service and platform user agreement.',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 space-y-6 text-white/70">
            <section>
              ...
              <p className="mt-2">
                By accessing or using the Oakmont Digital Markets Groups platform, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree, you may not use the platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Digital assets are highly volatile. You acknowledge the risk of total loss and that Oakmont Digital Markets Groups does not provide investment advice. All trading decisions are your sole responsibility.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                You may not use the platform for money laundering, fraud, market manipulation, or any unlawful activity. Oakmont Digital Markets Groups reserves the right to suspend accounts and report suspicious activity to authorities.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Oakmont Digital Markets Groups is not liable for losses resulting from market volatility, third-party service failures, or force majeure events. Maximum liability is limited to fees paid in the 12 months prior to the claim.
              </p>
            </section>
