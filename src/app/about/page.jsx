...
export const metadata = {
    title: 'About Oakmont Digital Markets Group',
    description: 'Learn about Oakmont Digital Markets Group - institutional-grade multi-asset brokerage and investment platform.',
};
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-display">
            About <span className="text-gradient-primary">Oakmont Digital Markets Group</span>
          </h1>
