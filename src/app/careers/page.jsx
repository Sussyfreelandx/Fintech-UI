      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-display">
            Careers at <span className="text-gradient-gold">Oakmont Digital Capital Group</span>
          </h1>
          ...
          <div className="mt-10">
            <a href="mailto:careers@oakmontdigitalcapital.com" className="btn-primary">Apply Now</a>
          </div>
        </div>
      </main>
      <Footer />
