...
export async function POST(req) {
  try {
    ...
    await sendEmail({
      to: user.email,
      subject: 'Your AurumX verification code',
      text: `Your AurumX verification code is ${code}. It expires in 30 minutes. If you did not request this, ignore this email.`,
      html: `<p>Your AurumX verification code is <strong style="font-size:20px;letter-spacing:2px">${code}</strong></p><p>It expires in 30 minutes. If you did not request this, ignore this email.</p>`,
    });
