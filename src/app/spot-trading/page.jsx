...
export const metadata = {
    title: 'Crypto Brokerage - Oakmont Digital Markets Groups',
    description: 'Trade BTC, ETH, USDT and major digital assets from the live Oakmont Digital Markets Groups brokerage hub.',
};

export default function SpotTradingPage() {
    return (<>
      <div className="relative min-h-screen bg-gradient-to-br from-charcoal-950/60 via-slate-950/50 to-zinc-950/60">
      <Navbar />
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-display">
            <span className="text-gradient-primary">Spot Trading</span> on Oakmont Digital Markets Groups
          </h1>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            <div className="glass p-6 rounded-xl">
              <TrendingUp className="h-8 w-8 text-accent-success mb-3"/>
          ...
          <div className="mt-10 flex gap-4">
              <Link href="/brokerage?tab=crypto" className="btn-primary">Open Live Crypto Brokerage</Link>
                   <Link href="/dashboard" className="btn-ghost">View Account Dashboard</Link>
          </div>
        </div>
      </main>
      <Footer />
