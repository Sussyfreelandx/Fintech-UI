...
export const BROKERAGE_UNIVERSE = {
  ...
  etfs: [
    ...
    { symbol: 'AGG',  name: 'iShares Core US Aggregate Bond ETF',     exchange: 'NYSE Arca' },
  ...
  crypto: [
    ...
    { symbol: 'SUI-USD',  name: 'Sui',            exchange: 'Crypto' },
    { symbol: 'FIL-USD',  name: 'Filecoin',       exchange: 'Crypto' },
    { symbol: 'INJ-USD',  name: 'Injective',      exchange: 'Crypto' },
    { symbol: 'PEPE-USD', name: 'Pepe',           exchange: 'Crypto' },
    { symbol: 'ETC-USD',  name: 'Ethereum Classic', exchange: 'Crypto' },
    { symbol: 'XLM-USD',  name: 'Stellar',        exchange: 'Crypto' },
    { symbol: 'ALGO-USD', name: 'Algorand',       exchange: 'Crypto' },
    { symbol: 'HBAR-USD', name: 'Hedera',         exchange: 'Crypto' },
    { symbol: 'ICP-USD',  name: 'Internet Computer', exchange: 'Crypto' },
    { symbol: 'RNDR-USD', name: 'Render',         exchange: 'Crypto' },
    { symbol: 'IMX-USD',  name: 'Immutable',      exchange: 'Crypto' },
  ],
};
