...
export const ASSETS = [
    { sym: 'BTC', name: 'Bitcoin', price: 71248.32, change: 2.41, color: '#06d6c4' },
    ...
    { sym: 'BNB', name: 'BNB', price: 612.18, change: 0.74, color: '#00c98b' },
    { sym: 'ADA', name: 'Cardano', price: 0.4621, change: -1.32, color: '#0033ad' },
    { sym: 'DOGE', name: 'Dogecoin', price: 0.1582, change: 3.27, color: '#38bdf8' },
