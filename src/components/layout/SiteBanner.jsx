    ...
    <>
      {s.maintenanceMode && (
        <div className="relative z-40 bg-accent-error/15 border-b border-accent-error/30 text-accent-error text-xs sm:text-sm px-4 py-2 text-center">
          ...
          <strong>Maintenance mode</strong> - Oakmont Digital Markets Groups is currently in read-only mode. Trading, investments and withdrawals are temporarily paused.
        </div>
      )}
