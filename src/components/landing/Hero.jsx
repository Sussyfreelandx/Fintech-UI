      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-14 sm:pt-14 sm:pb-16 lg:pt-24 lg:pb-24 grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <p className="mt-5 text-base sm:text-lg leading-relaxed text-white/70 max-w-xl">
            Oakmont Digital Markets Groups is a regulated multi-asset brokerage. Trade stocks, ETFs, indices, cryptocurrencies, forex, commodities, futures and options from a single live account, with institutional-grade custody, compliant onboarding, and admin-controlled investment servicing.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-x-5 gap-y-3 text-sm text-white/60">
            ...
            <span className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-cyan-400"/> Live equities, FX, crypto &amp; futures</span>
            <span className="flex items-center gap-2"><Sparkles className="h-4 w-4 text-cyan-400"/> Smart order routing &amp; risk controls</span>
          </div>
        </motion.div>
