...
export function Security() {
    return (<section className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
      <div className="max-w-2xl">
        <span className="chip bg-gold-500/15 text-gold-400 border border-gold-500/30">Security & Compliance</span>
        ...
        <p className="mt-3 text-white/65">
          AurumX applies traditional-finance controls to digital assets: signed-in access, KYC/AML workflows, admin-controlled account servicing, audit logs, transactional email notices, and clear reporting for every client action.
        </p>
      </div>
