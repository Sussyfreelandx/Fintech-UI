...
const faqs = [
    { q: 'Is Oakmont Digital Capital Group regulated?', a: 'Yes. Oakmont Digital Capital Group operates regulated entities under MiCA (EU), FCA (UK), MSB (US FinCEN), and DIFC. We comply with AML/CFT, the Travel Rule, and applicable consumer protection rules.' },
    ...
    { q: 'Can I integrate via API?', a: 'Yes - Oakmont Digital Capital Group offers REST and FIX 4.4 APIs, WebSocket market data, and OMS/EMS integrations (Talos, Crossover, Wyden).' },
