...
const faqs = [
    ...
    { q: 'Is Oakmont Digital Markets Groups regulated?', a: 'Yes. Oakmont Digital Markets Groups operates regulated entities under MiCA (EU), FCA (UK), MSB (US FinCEN), and DIFC. We comply with AML/CFT, the Travel Rule, MiFID II suitability and applicable consumer protection rules.' },
