...
const faqs = [
    ...
    { q: 'Do you support API access?', a: 'Yes - Oakmont DMG offers REST and FIX 4.4 APIs, WebSocket market data, and OMS/EMS integrations (Talos, Crossover, Wyden) covering every asset class on the brokerage.' },
