...
const faqs = [
    { q: 'What can I trade at Oakmont Digital Markets Groups?', a: 'Oakmont Digital Markets Groups operates as a full multi-asset brokerage. From a single verified account you can trade stocks, ETFs, indices, cryptocurrencies (BTC, ETH and 25+ majors), forex (G10 majors and crosses), commodities (silver, oil, natural gas, copper, grains), futures (CME E-mini index, FX and Treasury futures) and listed equity / ETF options.' },
    { q: 'Is Oakmont Digital Markets Groups regulated?', a: 'Yes. Oakmont Digital Markets Groups operates with financial-services compliance controls, AML/CFT procedures, Travel Rule support, suitability review, and applicable consumer protection standards.' },
    ...
    { q: 'Do you support API access?', a: 'Yes - Oakmont Digital Markets Groups offers REST and FIX 4.4 APIs, WebSocket market data, and OMS/EMS integrations covering every asset class on the brokerage.' },
    { q: 'Do you support fiat on/off-ramps?', a: 'Yes - major fiat funding rails are supported through institutional transfer networks with same-day settlement options for verified institutions.' },
