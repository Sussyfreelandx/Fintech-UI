...
const faqs = [
    ...
    { q: 'Do you support API access?', a: 'Yes - Oakmont Digital Capital Group offers REST and FIX 4.4 APIs, WebSocket market data, and OMS/EMS integrations covering every asset class on the brokerage.' },
