...
const faqs = [
    { q: 'What can I trade at Oakmont Digital Capital Group?', a: 'Oakmont DCG operates as a full multi-asset brokerage. From a single verified account you can trade stocks, ETFs, indices, cryptocurrencies (BTC, ETH and 25+ majors), forex (G10 majors and crosses), commodities (gold, silver, oil, natural gas, copper, grains), futures (CME E-mini index, FX and Treasury futures) and listed equity / ETF options.' },
    { q: 'Is Oakmont Digital Capital Group regulated?', a: 'Yes. Oakmont Digital Capital Group operates regulated entities under MiCA (EU), FCA (UK), MSB (US FinCEN), and DIFC. We comply with AML/CFT, the Travel Rule, MiFID II suitability and applicable consumer protection rules.' },
    ...
    { q: 'Do you support API access?', a: 'Yes - Oakmont DCG offers REST and FIX 4.4 APIs, WebSocket market data, and OMS/EMS integrations (Talos, Crossover, Wyden) covering every asset class on the brokerage.' },
