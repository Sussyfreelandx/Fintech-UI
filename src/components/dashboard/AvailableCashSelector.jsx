        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="absolute top-full left-0 right-0 mt-2 z-[90] rounded-xl border border-slate-700/20 bg-navy-900/95 p-2 shadow-xl backdrop-blur-xl max-h-[300px] overflow-y-auto"
            >
              <p className="px-3 pb-2 pt-1 text-[11px] uppercase tracking-[0.2em] text-white/50">{t('selectAsset')}</p>
